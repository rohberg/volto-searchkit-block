# Volto searchkit block (@rohberg/volto-searchkit-block)
...
yo @plone/volto my-volto-project --addon @rohberg/volto-searchkit-block
cd my-volto-project
```

Add `@rohberg/volto-searchkit-block` to your package.json:
...
```javascript
const theme = '@rohberg/volto-searchkit-block';
```
...
Crafted with care by **Generated using [Cookieplone (0.7.1)](https://github.com/plone/cookieplone) and [cookiecutter-plone (5546534)](https://github.com/plone/cookiecutter-plone/commit/5546534df628a86d1e720069e17006e0b8eb66a4) on 2024-06-24 10:22:32.851752**. A special thanks to all contributors and supporters!
